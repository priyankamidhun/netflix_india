...
function Banner({ fetchUrl }) {
    ...
    return (
        <>
            <div style={{
                height: "600px", backgroundPosition: "center", backgroundAttachment: "fixed", width: "100%",
                backgroundImage: `url(${base_url}${movie?.backdrop_path})`
            }}>
                <div className="banner_content">
                    <h1>{movie?.name}</h1>
                    <button className="btn btn-danger">Play<i class="fa-solid fa-play bg-transparent ms-2"></i></button>
                    <button className="btn border-white ms-3 more">More Info<i class="fa-solid fa-caret-down bg-transparent ms-2"></i>
                    </button>
